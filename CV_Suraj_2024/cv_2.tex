...
10+ Global startups served with high-performance, fault-tolerant, weapons-grade secure software solutions across technologies and industries. Prior experiences in government, financial journalism, and content strategy.
...
\textbf Self-employed, Remote/India \hfill {\scriptsize \it Full Stack Web Development Services}
\begin{itemize}\smallskip\smallskip
\item Shipping software and web products with self-effacing transparency and precision to global business teams, including YC alumni 
\item Specialties: {\sl Cross-platform mobile apps and browser extensions, API/SDK integrations, Smart Contract testing, Zero-knowledge ecryption, FHE, sublime frontends, and cost-and-energy-saving DevOps} 
\item Industries Served: {\sl Web3/De-Fi, Fintech, Ed-tech, Fashion-tech, E-retail, Sales-tech } 

\item Clientele:
\begin{itemize}
\item {\sl Holdex}, Hong Kong - Full stack Web3 development, Smart-contract testing
\item {\sl Clearpool Finance}, De-Fi - Full stack Web3 development
...
\item {\sl Bombay Shirt Company}, Mumbai - Client-side optimisations on factory-to-customer e-retail solution for a 27-30 percent optimised frontend
