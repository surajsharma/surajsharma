...
Stack, framework, and language agnostic development, deployment, distribution, and maintenance of exceptional software and distributed systems on the edge, cloud, and downstream (mobile/IoT).
...
\item Specialties: {\sl Developer experience and tooling, Domain-specific solutions, Front-End, APIs and API integrations, QC, Cross-platform browser extensions} 
