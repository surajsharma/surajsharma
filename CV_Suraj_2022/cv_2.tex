...
\moveright1 \hoffset\centerline {\sl{\href{mailto:suraj@evenzero.in}{\ttfamily  suraj@evenzero.in}} | \ttfamily +91-9108103295 }  
\smallskip\smallskip
...
{\sl Software Developer (evenzero.in)} \hfill Jun 2018 - \color{CadetBlue} Present\color{Black}\\
...
\item Shipping with self-effacing transparency and care - commercial, open-source, and bespoke web products to global business teams and Y-Combinator alumni
\item Clientele:
\begin{itemize}
...
\item Specialties: {\sl In-app content strategy, Front-end tuning and upgrade, Domain-specific solutions, Customised tooling (Babel, Webpack, Vite)} 
