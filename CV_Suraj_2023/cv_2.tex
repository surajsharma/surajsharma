...
{\sl \textbf{Languages} :} JS/TS, Python, Ruby, C, Processing, GraphQL ...\\
{\sl \textbf{Frontend} :} React(Native), NextJS, Svelte(Kit), Tailwind, Pug, Jekyll, Gatsby  ...\\
{\sl \textbf{Backend} :} NodeJS, Express, FastAPI, NestJS, Flask, Rails ...\\
{\sl \textbf{Tooling} :} WebPack, Vite, Babel, WebAssembly ... \\
{\sl \textbf{Datastores} :} Postgres, SQL(ite)/, Mongo, Firebase, Redis, DynamoDB, IDB\\
{\sl \textbf{Operations} :} *nix/osx, Docker, AWS, GCP, Cloudflare, Azure, DigitalOcean ...\\
{\sl \textbf{Web3}: } Solidity, Cairo, Solana, Polygon, Flow
