...
Software artisan and author with media and e-governance experience.
...
{\sl Languages :} JavaScript/TypeScript, Python, SQL, Processing, Erlang/Elixir, Lua\\
\smallskip\smallskip
...
\smallskip
{\sl Frameworks :} React, Svelte, Express, FastAPI, NextJS, Phoenix\\
...
\item Shipping with self-effacing transparency and flawless precision - commercial, open-source, and bespoke web products to global business teams and Y-Combinator alumni
\item Clientele:
\begin{itemize}
...
\item Specialties: {\sl Developer experience and tooling, Domain-specific solutions, Front-End, Content Strategy } 
...
\item ZenTube : An open-source cross-browser plugin to censor YouTube
\
\end{itemize}
